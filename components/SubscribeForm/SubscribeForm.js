      ...
      <div className={cx("component")}>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className={cx("subs-forms-field")}>
            <label className={cx("subs-forms-field-label")}>
              {"Name "}
              <span className={cx("subs-forms-required-label")}>{"*"}</span>
            </label>
            <input
              className={cx("subs-forms-field-medium")}
              {...register("name", { required: "Name is required" })}
            />
            {errors.name && (
              <span className={cx("subs-forms-errors")}>
                {errors.name.message + " *"}
              </span>
            )}
          </div>
          ...
          <div className={cx("subs-forms-field")}>
            <label className={cx("subs-forms-field-label")}>{"Address"}</label>
            <input
              className={cx("subs-forms-field-medium")}
              {...register("address")}
            />
          ...
          <div className={cx("subs-forms-field")}>
            <label className={cx("subs-forms-field-label")}>{"Zip Code"}</label>
            <input
              className={cx("subs-forms-field-medium")}
              {...register("zipcode")}
            />
          ...
          <div className={cx("subs-forms-field")}>
            ...
            <ul>
              <li>
                <input
                  ...
                  type="radio"
                  id="singleCopy"
                  value="Single Copy Issue"
                  {...register("subscriptionPeriod", {
                    required: "Please select a subscription period",
                  })}
                />
                <label htmlFor="singleCopy">{"Single Copy Issue"}</label>
              </li>
              <li>
                <input
                  className={cx("subs-forms-field-medium")}
                ...
                />
                <label htmlFor="oneYear">{"1-Year Subscription"}</label>
              </li>
            </ul>
            {/* <div>
              <input
            ...
            {errors.subscriptionPeriod && (
              <span className={cx("subs-forms-errors")}>
                {errors.subscriptionPeriod.message + " *"}
              </span>
            )}
          </div>
          ...
          <div className={cx("subs-forms-field")}>
            ...
            <ul>
              <li>
                ...
                />
                <label htmlFor="latestIssue">{"Latest Issue"}</label>
              </li>
              <li>
                <input
                  className={cx("subs-forms-field-medium")}
                ...
                />
                <label htmlFor="nextIssue">{"Next Issue"}</label>
              </li>
            </ul>
            {errors.startingFrom && (
              <span className={cx("subs-forms-errors")}>
          ...
          <div className={cx("subs-forms-field")}>
            <label className={cx("subs-forms-field-label")}>{"Message"}</label>
            <textarea
              className={cx("subs-forms-field-medium")}
              {...register("message")}
            />
